          ...
          <div className="PlayerWrapper unselectable">
            <div className="PlayerHeader align-items-center row p-2">
              <div className="col-7 col-md-4 pr-0 align-self-center order-first">
                <div className="row">
                  <h4 className={'PlayerRank text-center pt-1 pl-2 ' + rankCls}>
                    {this.props.value + 1}
                  </h4>
                  <a
                    className="armoryLink"
                    href={
                      'https://worldofwarcraft.com/en-us/character/frostmourne/' +
                  ...
                  <div className="row mx-auto mx-0 p-0">
                    <a
                      onMouseEnter={this.raidbotsEnter}
                      onMouseLeave={this.raidbotsLeave}
                      className="d-flex align-items-center mr-1 mb-1"
                      rel="noopener noreferrer"
                      href={'https://raidbots.com/simbot/report/' + this.props.player.reportID}
                      target="_blank"
                    >
                      <img
                        className="rbIco "
                        src={'src/' + this.props.rbIco}
                        alt=""
                        height="30px"
                      />
                    </a>
                    {this.state.hideRaidbots ? null : (
                      <RaidbotsTooltip player={this.props.player} rbots={true} key={1} />
                    )}
                    <img
                      onMouseEnter={this.armoryEnter}
                      onMouseLeave={this.armoryLeave}
                      className="roleIco ml-3 align-self-center"
                      src={'src/' + roleIcon}
                      alt=""
                      height="30px"
                    />
                    {this.state.hideArmory ? null : (
                      <RaidbotsTooltip player={this.props.player} rbots={false} key={1} />
                    )}
                  </div>
                </div>
              </div>
