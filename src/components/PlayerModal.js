    ...
    return (
      <div className="PlayerModalWrapper align-items-center">
        <a
          ...
          href={'https://worldofwarcraft.com/en-us/character/frostmourne/' + this.props.player.name}
          rel="noopener noreferrer"
          target="_blank"
        >
          <div
            className="LootHeader p-1 unselectable bg-dark rounded d-flex align-items-center"
