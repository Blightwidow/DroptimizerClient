...
const API_UPDATE = `${API_DOMAIN}/1/update/report/`;
...
class PageHeader extends Component {
  ...
  getItems = (term) => {
    ...
    for (var i = 0; i < this.props.items.length; i++) {
      ...
      for (var j = 0; j < obj.length; j++) {
        ...
        if (j !== 0) {
          // if not name, check for full match
          ...
          // if name, check for partial match
  ...
  submitReport = () => {
    ...
    axios.get(API_UPDATE + reportID, { crossdomain: true }).then((response) => {
    ...
    return (
      <div>
            ...
            <div className="modal-content bg-dark text-light">
              <div className="modal-header ">
                <h5 className="modal-title align-self-center d-flex" id="exampleModalLongTitle">
                  {'Bastion Raid Roster - ' + (leftPlayer.length + rightPlayer.length) + ' Players'}
                </h5>
                <button
                  type="button"
              ...
              <div className="modal-body">
                <div className="row d-flex">
                  <div className="col p-0 pl-2 mb-1 mx-1">{leftPlayer}</div>
                  <div className="col p-0 pr-2 mb-1 mx-1">{rightPlayer}</div>
                </div>
                <div className="row d-flex">
                  {this.state.noAlert ? null : (
                    <div className="alertWrapper mb-3">
                  ...
                  <div className="input-group w-75 px-3 mx-auto my-2">
                    <div className="input-group-prepend">
                      <button
                        className="btn wowBtn btn-outline-secondary searchBar disabled"
                        type="button"
                      >
              ...
              <div className="modal-footer">
                ...
                <div className="col-2 d-flex mx-auto justify-content-center align-self-center px-1">
                  <a
                    href="https://www.wowprogress.com/guild/us/frostmourne/Bastion"
                    title="Guild WoW Progress"
                    rel="noopener noreferrer"
                    target="_blank"
                  >
                ...
                <div className="col-2 d-flex mx-auto justify-content-center align-self-center px-1">
                  <a
                    href="https://www.warcraftlogs.com/guild/us/frostmourne/bastion"
                    title="Guild Logs"
                    rel="noopener noreferrer"
                    target="_blank"
                  >
                ...
                <div className="col-2 d-flex mx-auto justify-content-center align-self-center px-1">
                  <a
                    href="https://raider.io/guilds/us/frostmourne/Bastion"
                    title="Guild Raider.io"
                    rel="noopener noreferrer"
                    target="_blank"
                  >
                ...
                <div className="col-2 d-flex mx-auto justify-content-center align-self-center px-1">
                  <a
                    href="https://www.youtube.com/playlist?list=PL6b8NnRTTfiT1XUdUuoXPYG1gWmMU_o2P"
                    rel="noopener noreferrer"
                    title="Guild Kill Videos"
                    target="_blank"
                  >
        ...
        <div className="PageHeaderWrapper align-items-center">
          <div
            className="PageHeader unselectable bg-dark rounded d-flex mt-2 mx-2 align-items-center"
          ...
          {loading ? (
            <div className="col mt-3 d-flex align-content-center">
              <img className="mx-auto" src="src/spinner.svg" alt="" height="60px" />
            </div>
          ) : null}
          {this.state.noLoot ? null : (
            <LootList loot={this.state.items} players={this.props.players} />
          )}
