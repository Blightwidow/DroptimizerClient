      ...
      <div className="LootHeader row bg-dark my-2 mx-1 rounded">
            ...
            <div className="col flex-grow-1 d-flex p-0">
              <div className="col-auto d-flex p-0 pr-2" onClick={this.onHeaderClick}>
                <a
                  ...
                  href="#!"
                  data-wowhead={'item=' + this.props.loot.id + '&ilvl=415'}
              ...
              <div className="col-auto d-flex flex-shrink-1 p-0">
                {
                  <a
                    ...
                    data-wh-rename-link="true"
                    href={'https://wowhead.com/item=' + this.props.loot.id + '&ilvl=415'}
              ...
              <div className="col p-0 flex-grow-1" onClick={this.onHeaderClick}></div>
            </div>
            {this.state.hideFilter ? null : (
              <button
        ...
        {this.state.collapsed ? null : (
          <PlayerList
            ...
            item={this.props.loot}
            isPercent={this.state.filterClicked}
